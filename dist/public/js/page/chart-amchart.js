...
function barChart() {
  ...
  valueAxis.renderer.labels.template.fill = am4core.color("#9aa0ac"); // Create series
...
function barChartWithImg() {
  ...
  var chart = am4core.create("barImg", am4charts.XYChart); // Add data
...
function lineChart() {
  ...
  var chart = am4core.create("lineChart", am4charts.XYChart); // Add data
...
function donutChart() {
  ...
  var chart = am4core.create("donutChart", am4charts.PieChart); // Add data
  ...
  pieSeries.labels.template.fill = am4core.color("#9aa0ac"); // This creates initial animation
...
function pieChart() {
  ...
  var chart = am4core.create("pieChart", am4charts.PieChart); // Add data
...
function gaugeChart() {
  ...
  var chart = am4core.create("gaugeChart", am4charts.RadarChart); // Add data
  ...
  chart.startAngle = -90;
  chart.endAngle = 180;
  chart.innerRadius = am4core.percent(20); // Set number format
...
function dumbbellPlotChart() {
  ...
  var open = 100;
  var close = 120;
  var names = ["Raina", "Demarcus", "Carlo", "Jacinda", "Richie", "Antony", "Amada", "Idalia", "Janella", "Marla", "Curtis", "Shellie"];
